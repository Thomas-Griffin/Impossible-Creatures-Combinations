...
def parse_combinations():
  ...
  for combination in sourceCombinations:
    currentCombination = {
      ...
      "Power"          : round(combination["attributes"]["Power"][1], 1) if "Power" in combination["attributes"] else -1,
      ...
      "EHP"            : round(combination["attributes"]["ehp"][1], 1) if "ehp" in combination["attributes"] else -1,
