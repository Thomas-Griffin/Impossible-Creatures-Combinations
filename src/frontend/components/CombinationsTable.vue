<template>
    <DataTable
        ...
        :export-filename="'combinations-export'"
    ...
    >
        <template #header>
            ...
            <Button
                ...
                label="Export"
                @click="table.exportCSV({selectionOnly: true, data: selectedCombinations})"
            />
        ...
        >
            <template #header>
                <img :src="`/icons/creature.svg`" alt="Animal 1" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
            ...
            <template #filter="{filterModel}">
                <InputText v-model="filterModel.value" class="p-column-filter" placeholder="Search" type="text" />
            </template>
        </Column>
        ...
        >
            <template #header>
                <img :src="`/icons/creature.svg`" alt="Animal 2" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
        ...
        >
            ...
            <template #filter="{filterModel}">
                <Slider
                    ...
                    :max="getColumnMinMax(CombinationAttributeNames.RESEARCH_LEVEL)[1] ?? 5"
                    :min="getColumnMinMax(CombinationAttributeNames.RESEARCH_LEVEL)[0] ?? 1"
                    class="m-3"
                    range
                ></Slider>
            ...
            <template #filterclear="{filterModel}">
                <Button class="p-button-sm p-button-outlined" label="Clear" @click="filterModel.value = [1, 5]" />
            </template>
        </Column>
        ...
        >
            ...
            <template #filterclear="{filterModel}">
                <Button
                    ...
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.COAL)"
                />
            </template>
        </Column>
        ...
        >
            <template #header>
                <img :src="`/icons/electricity.svg`" alt="Electricity" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
            ...
            <template #filter="{filterModel}">
                ...
                <div class="flex align-items-center justify-content-between px-2">
                    <InputNumber
                        v-model="filterModel.value[0]"
                        :max="filterModel.value ? filterModel.value[1] : filterModel.value[1]"
                        :min="
                            filterModel.value
                                ? filterModel.value[0]
                                : getColumnMinMax(CombinationAttributeNames.ELECTRICITY)[0]
                        "
                    />
                    <InputNumber
                        v-model="filterModel.value[1]"
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.ELECTRICITY)"
                />
            </template>
        </Column>
        <Column
        ...
        >
            <template #header>
                <img :src="`/icons/creature.svg`" alt="Front Legs" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
        ...
        >
            <template #header>
                <img :src="`/icons/creature.svg`" alt="Rear Legs" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
        ...
        >
            <template #header>
                <img :src="`/icons/creature.svg`" alt="Pincers" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
        ...
        >
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.DEFENCE)"
                />
            </template>
        </Column>
        ...
        >
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.HEALTH)"
                />
            </template>
        </Column>
        ...
        >
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.EHP)"
                />
            </template>
        </Column>
        ...
        >
            <template #header>
                <img :src="`/icons/melee-damage.svg`" alt="Melee Damage" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.MELEE_DAMAGE)"
                />
            </template>
        </Column>
        ...
        >
            <template #header>
                <img :src="`/icons/population.svg`" alt="Population" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.POPULATION_SIZE)"
                />
            </template>
        </Column>
        ...
        >
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.POWER)"
                />
            </template>
        </Column>
        ...
        >
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.SDT)"
                />
            </template>
        </Column>
        ...
        >
            <template #header>
                <img :src="`/icons/sight-radius.svg`" alt="Sight Radius" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.SIGHT_RADIUS)"
                />
            </template>
        </Column>
        ...
        >
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.SIZE)"
                />
            </template>
        </Column>
        ...
        >
            <template #header>
                <img :src="`/icons/land-speed.svg`" alt="Land Speed" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.LAND_SPEED)"
                />
            </template>
        </Column>
        ...
        >
            <template #header>
                <img :src="`/icons/water-speed.svg`" alt="Water Speed" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
                ...
                <div class="flex align-items-center justify-content-between px-2">
                    <InputNumber
                        ...
                        :min="
                            filterModel.value
                                ? filterModel.value[0]
                                : getColumnMinMax(CombinationAttributeNames.WATER_SPEED)[0]
                        "
                    />
                    <InputNumber
                        v-model="filterModel.value[1]"
                        :max="
                            filterModel.value
                                ? filterModel.value[1]
                                : getColumnMinMax(CombinationAttributeNames.WATER_SPEED)[1]
                        "
                        :min="filterModel.value[0]"
                        style="margin-left: 4rem"
                    />
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.WATER_SPEED)"
                />
            </template>
        </Column>
        ...
        >
            <template #header>
                <img :src="`/icons/air-speed.svg`" alt="Air Speed" style="height: 2.5rem" />
            </template>
            <template #body="{data}">
                ...
                <div class="flex align-items-center justify-content-between px-2">
                    <InputNumber
                        ...
                        :min="
                            filterModel.value
                                ? filterModel.value[0]
                                : getColumnMinMax(CombinationAttributeNames.AIR_SPEED)[0]
                        "
                    />
                    <InputNumber
                        v-model="filterModel.value[1]"
                        :max="
                            filterModel.value
                                ? filterModel.value[1]
                                : getColumnMinMax(CombinationAttributeNames.AIR_SPEED)[1]
                        "
                        :min="filterModel.value[0]"
                        style="margin-left: 4rem"
                    />
            ...
            <template #filterclear="{filterModel}">
                <Button
                    class="p-button-sm p-button-outlined"
                    label="Clear"
                    @click="filterModel.value = getColumnMinMax(CombinationAttributeNames.AIR_SPEED)"
                />
            </template>
        </Column>
        ...
        >
            <template #body="{data}">
                <div class="flex align-items-center gap-2">
                    <span>{{ convertToEnumeratedFormatString(data[CombinationAttributeNames.ABILITIES]) }}</span>
                </div>
            </template>
            <template #filterheader>
        ...
        <Column
            v-if="columnIsSelected(CombinationAttributeNames.ABILITY_SOURCES)"
            :export-header="CombinationAttributeNames.ABILITY_SOURCES"
            :exportable="true"
            :field="CombinationAttributeNames.ABILITY_SOURCES"
            :filterField="CombinationAttributeNames.ABILITY_SOURCES"
            :header="CombinationAttributeNames.ABILITY_SOURCES"
            :showFilterMatchModes="false"
            body-style="text-align: center"
        >
            <template #body="{data}">
                <div class="flex align-items-center gap-2">
                    <span>{{ convertToEnumeratedFormatString(data[CombinationAttributeNames.ABILITY_SOURCES]) }}</span>
                </div>
            </template>
            <template #filterheader>
...
const initialiseColumns = () => {
    ...
    columns.value = modColumns
    selectedColumns.value = modColumns
}

const getColumnMinMax = (columnName: CombinationAttributeNames) => {
    const column = modStore.getMod.columns?.find((column: ModColumn) => column.label === columnName) as ModColumn
...
const tableRequest = async () => {
    ...
    loading.value = true
    let combinationsRequestBody: CombinationsRequestBody = {
        mod: modStore.getMod,
...
const onSort = async (event: DataTableSortEvent) => {
    ...
    sorting.value = {
        column: event.multiSortMeta[0].field as CombinationAttributeNames,
        order: event.multiSortMeta[0].order === 1 ? SortingType.ASCENDING : SortingType.DESCENDING,
    }
    await tableRequest()
}
...
const onUpdateRows = (value: number) => {
...
const columnIsSelected = (columnName: CombinationAttributeNames) => {
    return selectedColumns.value.some((column: CombinationTableColumn) => column.name === columnName)
}

const convertToEnumeratedFormatString = (stringArray: string[]) => {
    return stringArray.map((ability: string, index: number) => `${index + 1}. ${ability}`).join(', ')
}

const transformDataForExport = (item: DataTableExportFunctionOptions) => {
    switch (item.field) {
        case CombinationAttributeNames.ABILITIES:
            return convertToEnumeratedFormatString(item.data)
        case CombinationAttributeNames.ABILITY_SOURCES:
            return convertToEnumeratedFormatString(item.data)
        default:
