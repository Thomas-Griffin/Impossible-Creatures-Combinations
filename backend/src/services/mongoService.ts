...
import {MONGO_CLIENT_TOKEN, MONGO_DOCKER_SERVICE_NAME, MONGO_DOCKER_SERVICE_PORT} from '../../globalConstants';
...
class MongoService {
    ...
    constructor() {
        ...
        this.client = container.resolve<MongoClient>(MONGO_CLIENT_TOKEN);
    }
}
