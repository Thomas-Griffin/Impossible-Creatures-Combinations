module.exports = {
  ...
  parserOptions: {
    parser: require.resolve('@typescript-eslint/parser'), extraFileExtensions: ['.vue'],
  },
  ...
  overrides: [{
    files: ['test/cypress/**/*.{js,jsx,ts,tsx}', '**/*.cy.{js,jsx,ts,tsx}'], extends: ['plugin:cypress/recommended',],
  },],
};
